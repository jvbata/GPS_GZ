...
public class GeocodeTask extends AsyncTask<String, Void, Boolean> {
	...
	private final static String GEOCODE_URL = "http://maps.googleapis.com/maps/api/geocode/json?sensor=true&latlng=";
	Context context;
	private String latitude, longitude;
	private String address;

	public GeocodeTask(Context context, double latitude, double longitude) {
	...
	private boolean parseJSONData(String jsonData) throws JSONException {
		...
		if (jsonGeocode.getString("status").equals("OK")) {
